...
// 3. Add Single Activity (Used in Explore Tab)
...
// 4. NEW: Log Daily Usage (Used for the Sliders)
...
// 8. NEW: Get Today's Slider Usage (For the Pie Chart)
...
// 9. NEW: Get Weekly History (Formatted for Recharts Bar Chart)
...
// 10. NEW: Gemini AI - Analyze Usage
...
// 11. NEW: Gemini AI - Eco-Coach Chat
